  ...
  return (
    <div className="page narrow-page hiw">
      ...
      <ol className="hiw-steps">
        ...
        <li>
          <h2>顺便问一句：这条记录放对地方了吗</h2>
          <p>
            概要出来之后，系统拿它和你已有的项目比一次，看这份材料像不像其中某一个的。够确定才会
            在记录上出现一条建议，说它可能该放进哪个项目；不够确定就不出声。点了挪过去，这条记录
            连同材料和逐字稿一起搬走；不点就什么都不会发生。
          </p>
          <p className="hiw-aside">
            上传时你自己在选择器里挑过项目的，这一条永远不会出现：那是你已经回答过的问题。
            已经有人确认过内容的记录也不能挪，因为确认过的结论属于它所在项目的账本。
          </p>
        </li>
        <li>
          <h2>事实线：先清点，再核对</h2>
