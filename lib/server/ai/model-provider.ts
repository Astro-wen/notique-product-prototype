  ...
  async extractClaims(input: ContextPack, signal?: AbortSignal) {
    ...
    try {
      ...
      const prompt = [
        ...
        scenarioInstruction,
        "Return no more than 10 of the most important material atomic claims. On a first event, aim for 5 to 10 only when the evidence supports that many; never split visual clutter or minor objects into claims to reach a quota.",
        ...
        "Within the 10-claim limit, prioritize material changes, resolutions, decisions, dates, assignments, and open risks over reaffirmations and minor observations.",
